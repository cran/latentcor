...
test_that("latentcor is symmetric.", {
  ...
  expect_equal(latentcor(X = X, types = c("con", "con"), method = "original", nu = 0.5, tol = 1e-8, ratio = .9, showplot = TRUE)$R,
               t(latentcor(X = X, types = c("con", "con"), method = "original", nu = 0.5, tol = 1e-8, ratio = .9, showplot = FALSE)$R))
  expect_equal(latentcor(X = X, types = c("con", "con"), method = "original", nu = 0.5, tol = 1e-8, ratio = .9, showplot = TRUE)$R,
               latentcor(X = X, method = "original", nu = 0.5, tol = 1e-8, ratio = .9, showplot = TRUE)$R)
})

test_that("latentcor is symmetric.", {
  X = gen_data(types = c("con", "con"))$X; colnames(X) = c("var1", "var2")
  expect_equal(latentcor(X = X, types = c("con", "con"), method = "approx", nu = 0.5, tol = 1e-8, ratio = .9, showplot = TRUE)$R,
               t(latentcor(X = X, types = c("con", "con"), method = "approx", nu = 0.5, tol = 1e-8, ratio = .9, showplot = FALSE)$R))
  expect_equal(latentcor(X = X, types = c("con", "con"), method = "approx", nu = 0.5, tol = 1e-8, ratio = .9, showplot = TRUE)$R,
               latentcor(X = X, method = "approx", nu = 0.5, tol = 1e-8, ratio = .9, showplot = TRUE)$R)

})

test_that("latentcor is symmetric.", {
  X = gen_data(types = c("bin", "bin"), rhos = 1)$X
  expect_equal(latentcor(X = X, types = c("bin", "bin"), method = "original", nu = 0.5, tol = 1e-8, ratio = .9, showplot = TRUE)$R,
...
test_that("latentcor is symmetric.", {
  ...
  expect_equal(latentcor(X = X, types = c("bin", "bin"), method = "approx", nu = 0.5, tol = 1e-8, ratio = .9, showplot = TRUE)$R,
